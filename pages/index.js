    ...
    <>
      <Head>
        ...
        <meta
          name="description"
          key="description"
          content="Pristine software custom-designed from the ground 
        up with cutting-edge optimizations. Use our free estimate calculator to check your project cost!"
        />
        <meta
          property="og:title"
      ...
      <Grid container direction="column" className={classes.mainContainer}>
        ...
        <Grid item>
          {" "}
          {/* <iOS/Android Apps Development Block>  */}
          <Grid
            container
            className={classes.serviceContainer}
